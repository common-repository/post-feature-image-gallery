...
class pfig_post_thumbnail extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        <div class="pfig">
			...
			while ( $pfig_post->have_posts() ) : $pfig_post->the_post();
				?>
                <div class="pfig-item" style="width: <?php echo $width; ?>;padding: <?php echo $padding ? $padding : 5; ?>px;">
	...
	public function form( $instance ) {
        ...
        <p>
            <label for=""><?php _e( 'Padding between Images (px):', 'pfig' ); ?></label>
            <input type="number" class="widefat" value="<?php echo $padding; ?>"
